...
export const CuSpeciality = ({ speciality, open, type, handleClose }) => {
  const dataDefault = {
    name: "",
    description: "",
  };
  ...
  const getDetail = async (id) => {
    let res = await getSpecialityById(id);
    ...
    <Modal open={open} onClose={() => handleCloseModal()}>
      ...
      >
        <Grid item xs={12} sx={{ p: 0, marginBottom: 2 }}>
          ...
          >
            {type === "Update" ? "Update speciality" : "Create speciality"}
          </Typography>
        </Grid>
