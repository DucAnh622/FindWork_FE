...
export const CuPermission = ({ permission, open, type, handleClose }) => {
  const dataDefault = {
    name: "",
    method: "",
    path: "",
  ...
  const getDetail = async (id) => {
    let res = await getPermissionById(id);
    ...
    <Modal open={open} onClose={() => handleCloseModal()}>
      ...
      >
        <Grid item xs={12} sx={{ p: 0, mb: 2, mt: 0 }}>
          ...
          >
            {type === "Update" ? "Update permission" : "Create permission"}
          </Typography>
        </Grid>
