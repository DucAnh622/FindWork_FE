...
import { formatSort, getStatusStyles } from "../../../utils/utils";
                    ...
                    list.map((row, index) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <TableCell align="left" title={row.speciality}>
                            <TextClamp>{row.speciality}</TextClamp>
                          </TableCell>
                          <TableCell align="left" title={row.address}>
                            <TextClamp>{row.address}</TextClamp>
                          </TableCell>
                          <TableCell align="left" title={row.phone}>
                            {row.phone}
                          </TableCell>
                          <TableCell align="left">
                            <Typography
                          ...
                          <TableCell align="left">
                            ...
                            >
                              <Link to={`/dashboard/company/update/${row.id}`}>
                                <IconButton
                                  aria-label="edit"
                                  size="medium"
                                  color="primary"
